...
set ruler
set runtimepath=~/.vim,~/.vim/plugged/fzf.vim,~/.vim/plugged/fzf,~/.vim/plugged/gruvbox,~/.vim/plugged/seoul256.vim,~/.vim/bundle/FastFold,~/.vim/bundle/SimpylFold,~/.vim/bundle/ale,~/.vim/bundle/clang_complete,~/.vim/bundle/fzf,~/.vim/bundle/fzf.vim,~/.vim/bundle/mru,~/.vim/bundle/nerdtree,~/.vim/bundle/nerdtree-git-plugin,~/.vim/bundle/tagbar,~/.vim/bundle/vim-airline,~/.vim/bundle/vim-autopep8,~/.vim/bundle/vim-better-whitespace,~/.vim/bundle/vim-clang-format,~/.vim/bundle/vim-flake8,~/.vim/bundle/vim-fugitive,~/.vim/bundle/vim-glsl,~/.vim/bundle/vim-go,~/.vim/bundle/vim-mypy,~/.vim/bundle/vim-plug,~/.vim/bundle/vim-python-pep8-indent,/var/lib/vim/addons,/etc/vim,/usr/share/vim/vimfiles,/usr/share/vim/vim91,/usr/share/vim/vim91/pack/dist/opt/termdebug,/usr/share/vim/vimfiles/after,/etc/vim/after,/var/lib/vim/addons/after,~/.vim/bundle/vim-glsl/after,~/.vim/bundle/nerdtree-git-plugin/after,~/.vim/after,/usr/local/opt/fzf
set shiftwidth=2
...
badd +1 src/Tutorial01.cpp
badd +1 include/intel_vulkan/Tutorial01.h
argglobal
%argdel
edit include/intel_vulkan/Tutorial01.h
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 60 + 119) / 238)
exe '2resize ' . ((&lines * 80 + 58) / 117)
exe 'vert 2resize ' . ((&columns * 88 + 119) / 238)
exe '3resize ' . ((&lines * 80 + 58) / 117)
exe 'vert 3resize ' . ((&columns * 88 + 119) / 238)
exe '4resize ' . ((&lines * 34 + 58) / 117)
exe 'vert 4resize ' . ((&columns * 177 + 119) / 238)
argglobal
enew
...
silent! normal! zE
let &fdl = &fdl
let s:l = 11 - ((7 * winheight(0) + 40) / 80)
...
wincmd w
argglobal
if bufexists(fnamemodify("src/Tutorial01.cpp", ":p")) | buffer src/Tutorial01.cpp | else | edit src/Tutorial01.cpp | endif
balt include/intel_vulkan/Tutorial01.h
nnoremap <buffer> <silent>  
let s:cpo_save=&cpo
set cpo&vim
nnoremap <buffer> <silent> <C-T> 
...
silent! normal! zE
let &fdl = &fdl
let s:l = 356 - ((0 * winheight(0) + 40) / 80)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 356
...
wincmd w
argglobal
terminal ++curwin ++cols=177 ++rows=34 
