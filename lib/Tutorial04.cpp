...
bool Tutorial04::CreatePipeline() {
  Tools::AutoDeleter<VkShaderModule, PFN_vkDestroyShaderModule>
      vertex_shader_module =
          CreateShaderModule("Data/Tutorials/04/shader.vert.spv");
  Tools::AutoDeleter<VkShaderModule, PFN_vkDestroyShaderModule>
      fragment_shader_module =
          CreateShaderModule("Data/Tutorials/04/shader.frag.spv");
...
bool Tutorial04::CreateCommandPool(uint32_t queue_family_index,
                                   VkCommandPool *pool) {
...
bool Tutorial04::AllocateCommandBuffers(VkCommandPool pool, uint32_t count,
