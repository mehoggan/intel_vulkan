...
bool Tutorial06::CreateCommandPool(uint32_t queue_family_index,
                                   VkCommandPool *pool) {
...
bool Tutorial06::AllocateCommandBuffers(VkCommandPool pool, uint32_t count,
...
bool Tutorial06::CreateTexture() {
  ...
  std::vector<char> texture_data = Tools::GetImageData(
      "Data/Tutorials/06/texture.png", 4, &width, &height, nullptr, &data_size);
...
bool Tutorial06::CopyTextureData(char *texture_data, uint32_t data_size,
...
bool Tutorial06::CreatePipeline() {
  Tools::AutoDeleter<VkShaderModule, PFN_vkDestroyShaderModule>
      vertex_shader_module =
          CreateShaderModule("Data/Tutorials/06/shader.vert.spv");
  Tools::AutoDeleter<VkShaderModule, PFN_vkDestroyShaderModule>
      fragment_shader_module =
          CreateShaderModule("Data/Tutorials/06/shader.frag.spv");
...
bool Tutorial06::Draw() {
  ...
  resource_index =
      (resource_index + 1) % VulkanTutorial06Parameters::ResourcesCount;
