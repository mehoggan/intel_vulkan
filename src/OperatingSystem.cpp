...
WindowParameters Window::GetParameters() const { return Parameters; }
...
bool Window::Create(const char* title) {
    ...
    // Create window
    Parameters.Handle = CreateWindow(SERIES_NAME,
                                     title,
                                     WS_OVERLAPPEDWINDOW,
                                     20,
                                     20,
...
bool Window::Create(const char* title) {
    ...
    xcb_create_window(Parameters.Connection,
    ...
    xcb_change_property(Parameters.Connection,
...
bool Window::Create(const char* title) {
    ...
    XSetStandardProperties(Parameters.DisplayPtr,
                           Parameters.Handle,
                           title,
                           title,
                           None,
                           ...
                           0,
                           nullptr);
    XSelectInput(Parameters.DisplayPtr,
                 Parameters.Handle,
...
bool Window::RenderingLoop(ProjectBase& project) const {
    ...
    XSetWMProtocols(
            Parameters.DisplayPtr, Parameters.Handle, &delete_window_atom, 1);
