...
Tutorial02::Tutorial02()
        : m_vulkan_library()
        , m_window_parameters()
        , m_vulkan_tutorial_02_parameters() {}
...
bool Tutorial02::createInstance() {
    ...
    if (vkCreateInstance(&instance_create_info,
                         nullptr,
                         &m_vulkan_tutorial_02_parameters.getVkInstance()) !=
        VK_SUCCESS) {
...
#define VK_INSTANCE_LEVEL_FUNCTION(fun)                                      \
    if (!(fun = (PFN_##fun)vkGetInstanceProcAddr(                            \
                  m_vulkan_tutorial_02_parameters.getVkInstance(), #fun))) { \
...
bool Tutorial02::createPresentationSurface() {
    ...
    if (vkCreateXlibSurfaceKHR(
                ...
                &surface_create_info,
                nullptr,
                &m_vulkan_tutorial_02_parameters.getPresentVkSurfaceKHR()) ==
        VK_SUCCESS) {
        return true;
    }
...
bool Tutorial02::createDevice() {
    ...
    for (uint32_t i = 0; i < num_devices; ++i) {
        if (checkPhysicalDeviceProperties(
            ...
            m_vulkan_tutorial_02_parameters.setVkPhysicalDevice(
                    physical_devices[i]);
            break;
        }
    }
    if (m_vulkan_tutorial_02_parameters.getVkPhysicalDevice() ==
        VK_NULL_HANDLE) {
    ...
    if (vkCreateDevice(m_vulkan_tutorial_02_parameters.getVkPhysicalDevice(),
                       &device_create_info,
                       nullptr,
                       &m_vulkan_tutorial_02_parameters.getVkDevice()) !=
        VK_SUCCESS) {
        std::cout << "Could not create Vulkan device!" << std::endl;
        return false;
    }

    m_vulkan_tutorial_02_parameters.setGraphicsQueueFamilyIndex(
            selected_graphics_queue_family_index);
    m_vulkan_tutorial_02_parameters.setPresentQueueFamilyIndex(
            selected_present_queue_family_index);
    return true;
}
...
#define VK_DEVICE_LEVEL_FUNCTION(fun)                                        \
    if (!(fun = (PFN_##fun)vkGetDeviceProcAddr(                              \
                  m_vulkan_tutorial_02_parameters.getVkDevice(), #fun))) {   \
...
bool Tutorial02::getDeviceQueue() {
    vkGetDeviceQueue(
            m_vulkan_tutorial_02_parameters.getVkDevice(),
            m_vulkan_tutorial_02_parameters.getGraphicsQueueFamilyIndex(),
            0,
            &m_vulkan_tutorial_02_parameters.getGraphicsVkQueue());
    vkGetDeviceQueue(
            m_vulkan_tutorial_02_parameters.getVkDevice(),
            m_vulkan_tutorial_02_parameters.getPresentQueueFamilyIndex(),
            0,
            &m_vulkan_tutorial_02_parameters.getPresentVkQueue());
    return true;
}
...
bool Tutorial02::createSemaphores() {
    ...
    if ((vkCreateSemaphore(m_vulkan_tutorial_02_parameters.getVkDevice(),
                           &semaphore_create_info,
                           nullptr,
                           &m_vulkan_tutorial_02_parameters
                                    .getImageAvailableVkSemaphore()) !=
         VK_SUCCESS) ||
        (vkCreateSemaphore(m_vulkan_tutorial_02_parameters.getVkDevice(),
                           &semaphore_create_info,
                           nullptr,
                           &m_vulkan_tutorial_02_parameters
...
bool Tutorial02::createSwapChain() {
    ...
    if (m_vulkan_tutorial_02_parameters.getVkDevice() != VK_NULL_HANDLE) {
        vkDeviceWaitIdle(m_vulkan_tutorial_02_parameters.getVkDevice());
    }

    VkSurfaceCapabilitiesKHR surface_capabilities;
    if (vkGetPhysicalDeviceSurfaceCapabilitiesKHR(
                m_vulkan_tutorial_02_parameters.getVkPhysicalDevice(),
                m_vulkan_tutorial_02_parameters.getPresentVkSurfaceKHR(),
    ...
    VkSwapchainKHR old_swap_chain =
            m_vulkan_tutorial_02_parameters.getVkSwapchainKHR();
    ...
    if (old_swap_chain != VK_NULL_HANDLE) {
        vkDestroySwapchainKHR(m_vulkan_tutorial_02_parameters.getVkDevice(),
                              old_swap_chain,
                              nullptr);
    }
...
bool Tutorial02::createCommandBuffers() {
    ...
    if (vkCreateCommandPool(m_vulkan_tutorial_02_parameters.getVkDevice(),
    ...
    m_vulkan_tutorial_02_parameters.getPresentQueueVkCommandBuffers().resize(
            image_count);

    VkCommandBufferAllocateInfo cmd_buffer_allocate_info = {
            VK_STRUCTURE_TYPE_COMMAND_BUFFER_ALLOCATE_INFO,
            nullptr,
            m_vulkan_tutorial_02_parameters.getPresentQueueVkCommandPool(),
            VK_COMMAND_BUFFER_LEVEL_PRIMARY,
            image_count};
    if (vkAllocateCommandBuffers(m_vulkan_tutorial_02_parameters.getVkDevice(),
...
bool Tutorial02::recordCommandBuffers() {
    uint32_t image_count = static_cast<uint32_t>(
            m_vulkan_tutorial_02_parameters.getPresentQueueVkCommandBuffers()
                    .size());
    ...
    for (uint32_t i = 0; i < image_count; ++i) {
        ...
        vkBeginCommandBuffer(m_vulkan_tutorial_02_parameters
                                     .getPresentQueueVkCommandBuffers()[i],
                             &cmd_buffer_begin_info);
        vkCmdPipelineBarrier(m_vulkan_tutorial_02_parameters
                                     .getPresentQueueVkCommandBuffers()[i],
        ...
        vkCmdClearColorImage(m_vulkan_tutorial_02_parameters
                                     .getPresentQueueVkCommandBuffers()[i],
                             swap_chain_images[i],
...
void Tutorial02::clear() {
    if (m_vulkan_tutorial_02_parameters.getVkDevice() != VK_NULL_HANDLE) {
        ...
        if ((m_vulkan_tutorial_02_parameters.getPresentQueueVkCommandBuffers()
                     .size() > 0ull) &&
            (m_vulkan_tutorial_02_parameters
        ...
        if (m_vulkan_tutorial_02_parameters.getPresentQueueVkCommandPool() !=
            VK_NULL_HANDLE) {
            vkDestroyCommandPool(m_vulkan_tutorial_02_parameters.getVkDevice(),
                                 m_vulkan_tutorial_02_parameters
                                         .getPresentQueueVkCommandPool(),
                                 nullptr);
            m_vulkan_tutorial_02_parameters.getPresentQueueVkCommandPool() =
...
bool Tutorial02::draw() {
    ...
    VkResult result = vkAcquireNextImageKHR(
            ...
            m_vulkan_tutorial_02_parameters.getVkSwapchainKHR(),
            UINT64_MAX,
            m_vulkan_tutorial_02_parameters.getImageAvailableVkSemaphore(),
            VK_NULL_HANDLE,
            &image_index);
    switch (result) {
        case VK_SUCCESS:
    ...
    if (vkQueueSubmit(m_vulkan_tutorial_02_parameters.getPresentVkQueue(),
                      1,
                      &submit_info,
    ...
    VkPresentInfoKHR present_info = {
            ...
            nullptr,
            1,
            &m_vulkan_tutorial_02_parameters.getRenderingFinishedVkSemaphore(),
            1,
            &m_vulkan_tutorial_02_parameters.getVkSwapchainKHR(),
            &image_index,
            nullptr};
...
Tutorial02::~Tutorial02() {
    ...
    if (m_vulkan_tutorial_02_parameters.getVkDevice() != VK_NULL_HANDLE) {
        ...
        if (m_vulkan_tutorial_02_parameters.getImageAvailableVkSemaphore() !=
            VK_NULL_HANDLE) {
            vkDestroySemaphore(m_vulkan_tutorial_02_parameters.getVkDevice(),
                               m_vulkan_tutorial_02_parameters
                                       .getImageAvailableVkSemaphore(),
                               nullptr);
        }
        if (m_vulkan_tutorial_02_parameters
                    .getRenderingFinishedVkSemaphore() != VK_NULL_HANDLE) {
            vkDestroySemaphore(m_vulkan_tutorial_02_parameters.getVkDevice(),
                               m_vulkan_tutorial_02_parameters
                                       .getRenderingFinishedVkSemaphore(),
                               nullptr);
        }
        if (m_vulkan_tutorial_02_parameters.getVkSwapchainKHR() !=
            VK_NULL_HANDLE) {
        ...
        vkDestroyDevice(m_vulkan_tutorial_02_parameters.getVkDevice(),
                        nullptr);
    }

    if (m_vulkan_tutorial_02_parameters.getPresentVkSurfaceKHR() !=
        VK_NULL_HANDLE) {
        vkDestroySurfaceKHR(
                m_vulkan_tutorial_02_parameters.getVkInstance(),
                m_vulkan_tutorial_02_parameters.getPresentVkSurfaceKHR(),
    ...
    if (m_vulkan_tutorial_02_parameters.getVkInstance() != VK_NULL_HANDLE) {
        vkDestroyInstance(m_vulkan_tutorial_02_parameters.getVkInstance(),
                          nullptr);
    }
