...
bool Tutorial05::CreateCommandPool(uint32_t queue_family_index,
                                   VkCommandPool *pool) {
...
bool Tutorial05::CreateFence(VkFenceCreateFlags flags, VkFence *fence) {
  ...
  if (vkCreateFence(GetDevice(), &fence_create_info, nullptr, fence) !=
      VK_SUCCESS) {
...
bool Tutorial05::CreatePipeline() {
  Tools::AutoDeleter<VkShaderModule, PFN_vkDestroyShaderModule>
      vertex_shader_module =
          CreateShaderModule("Data/Tutorials/05/shader.vert.spv");
  Tools::AutoDeleter<VkShaderModule, PFN_vkDestroyShaderModule>
      fragment_shader_module =
          CreateShaderModule("Data/Tutorials/05/shader.frag.spv");
...
bool Tutorial05::ChildOnWindowSizeChanged() { return true; }
...
bool Tutorial05::Draw() {
  ...
  resource_index =
      (resource_index + 1) % VulkanTutorial05Parameters::ResourcesCount;
